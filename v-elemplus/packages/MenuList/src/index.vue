<template>
    ...
    >
        <template v-for="(item, i) in data" :key="i">
            <el-menu-item v-if="!item[children] || !item[children].length" :index="item[index]" @click="changeItem(item)">
            ...
            <el-sub-menu v-if="item[children] && item[children].length" :index="item[index]">
                ...
                <el-menu-item v-for="(item1, index1) in item[children]" :key="index1" :index="item1[index]" @click="changeItem(item1)">
