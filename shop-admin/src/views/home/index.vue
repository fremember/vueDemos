    ...
    <div class="home">
        ...
        <el-row :gutter="20" class="mt-5">
            ...
            <el-col :span="12" :offset="0" v-permission="['getStatistics2,GET']">
                <home-card title="店铺及商品提示" tip="店铺及商品提示" :btns="goods" class="mb-3" />
                <home-card title="交易提示" tip="需要立即处理的交易订单" :btns="order" />
            </el-col>
        </el-row>
    </div>
</template>
...
<script setup>
    ...
    import { getStatistics1, getStatistics2 } from '@/api/home'
    const panels = ref([]),
        goods = ref([]),
        order = ref([]);
